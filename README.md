...
- 게시글 목록, 본문, 댓글은 관리자 발급 인증 코드를 확인한 회원과 관리자만 열람할 수 있습니다.
- 인증된 회원은 표시 이름과 4자 이상의 비밀번호를 설정해 글과 댓글을 작성합니다.
- 작성자는 설정한 비밀번호로 자신의 글을 수정·삭제하고 댓글을 삭제할 수 있습니다.
- 관리자는 모든 글과 댓글을 수정·삭제할 수 있습니다.
- 글 또는 댓글 비밀번호는 원문으로 저장하지 않습니다.
